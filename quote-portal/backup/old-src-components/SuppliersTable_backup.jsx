...
export default function SuppliersTable({ 
  ...
  // Malzeme yönetimi hook'ları kaldırıldı
  ...
  // Malzeme kategorileri ve tab yapısı kaldırıldı
  ...
  useEffect(() => {
    if (selectedSupplierId && suppliers && suppliers.length > 0) {
      ...
      if (currentSupplier) {
        // Supplier bulundu - her zaman güncel veriyle güncelle
        // Supplier güncelleniyor
        ...
        <div style={{ flex: 1, overflowY: 'auto', paddingRight: '8px' }}>
          <form onSubmit={handleSaveSupplier} id="supplier-detail-form">
            ...
            {/* Malzemeler kısmı kaldırıldı */}
                    ...
                    onClick={(e) => {
                      ...
                      if (onAddNewMaterial) {
                        onAddNewMaterial(selectedSupplier, (materialOrCallbackData) => {
                          ...
                          console.log('✅ SuppliersTable: Tedarikçi detayında malzeme ekleniyor:', newMaterial)
                          
                          // Backend güncellemesi tamamlandıktan sonra suppliers listesini yenile
                          // selectedSupplier useEffect'le otomatik güncellenecek
              ...
              <div style={{ fontSize: '12px', color: '#6b7280' }}>
                {/* Debug: Malzeme sayısını göster */}
                {console.log('🔍 SuppliersTable: Malzeme listesi render edildi:', {
                  supplierId: selectedSupplier?.id,
                  supplierCode: selectedSupplier?.code,
                  materialsCount: selectedSupplier?.suppliedMaterials?.length || 0,
                  materials: selectedSupplier?.suppliedMaterials
                })}
