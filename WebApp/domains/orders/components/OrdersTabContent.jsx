...
export default function OrdersTabContent() {
  ...
  // System settings for conditional lot tracking UI
                ...
                <div style={{ 
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '16px' }}>
                    ...
                    <div className="detail-item" style={{ display: 'flex', alignItems: 'center', marginBottom: '8px' }}>
                      ...
                      <span className="detail-value" style={{ fontSize: '12px', color: '#111827', fontWeight: '600' }}>
        ...
        >
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              {/* Lot Tracking Fields - Only show when lotTracking is enabled */}
              ...
              {/* Info Message - Only show when lotTracking is enabled */}
              {systemSettings.lotTracking && (
                <div style={{
                  background: '#eff6ff',
